...
In our case though we solve right away that $v_1+v_2+v_3=\begin{pmatrix}1&1\\0&0\\0&0\end{pmatrix}+\begin{pmatrix}0&0\\1&1\\0&0\end{pmatrix}+\begin{pmatrix}0&0\\0&0\\1&1\end{pmatrix}=\begin{pmatrix}1&1\\1&1\\1&1\end{pmatrix}$ Thus $v_1+v_2+v_3=v_4+v_5$, in other words $v_1+v_2+v_3-v_4-v_5=0$ so {$v_1,...,v_5$} linear independent
